...
import 'swiper/css'
import 'swiper/css/effect-fade' // Necesario para el efecto fade
          ...
          {heroSlidesData.map((slide) => (
            <SwiperSlide key={slide.id}>
              <div
                ...
                // Pasamos la URL de la imagen como una variable CSS
                style={{ '--hero-bg-image': `url(${slide.image})` }}
              >
